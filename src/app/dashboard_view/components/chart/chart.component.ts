...
import {ChartConfigsType, ChartDataType, ChartType} from 'src/app/dashboard_view/components/chart/chart.types';

declare var google: any;

@Component({
  selector: 'tk-chart', templateUrl: './chart.component.html',
})
export class ChartComponent implements OnChanges {
  ...
  drawChart(chartData: ChartDataType): void {
    const data = google.visualization.arrayToDataTable([
      chartData.fieldNames, ...chartData.data,
    ]);
