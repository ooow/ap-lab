...
export class ProductTableHarness extends ComponentHarness {
  ...
  async deleteProductBtns(id?: number): Promise<MatButtonHarness | MatButtonHarness[] | null> {
  ...
  async productDetailsLinks(id?: number): Promise<MatButtonHarness | MatButtonHarness[] | null> {
