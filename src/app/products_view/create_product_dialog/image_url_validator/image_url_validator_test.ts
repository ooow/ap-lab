...
import * as validator from './image_url_validator';
...
describe('ImageUrlValidator', () => {
  ...
  it('should return observable error when url is a non image url', () => {
    const testNonImageUrl = 'https://github.com/vnazarchukGD/angular-time-killer';
  ...
  it('should call isImageUrl method when url match pattern', async () => {
    ...
    const imageUrlOne = 'https://www.royal-canin.ru/upload/iblock/117/avstr.ovcharka2.jpg';
    const imageUrlTwo = 'www.royal-canin.ru/upload/iblock/117/avstr.ovcharka2.gif';
    const imageUrlThree = 'https://www.snopes.com/tachyon/2020/03/ss_corona_beer.png?resize=865,452';
