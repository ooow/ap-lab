...
const PRODUCTS_MOCK_EN: ReadonlyArray<Product> = [
  ...
  },
  {
    ...
    counts: [
      { location: 'USA', quantityAvailable: '54' },
      { location: 'Canada', quantityAvailable: '45' },
      { location: 'France', quantityAvailable: '23' },
      { location: 'United Kingdom', quantityAvailable: '4' },
      { location: 'Australia', quantityAvailable: '23' }
    ]
  },
  {
    ...
    picture:
      'https://2.bp.blogspot.com/-pbdNn_1TOyI/V14_6BIJXGI/AAAAAAAAF2o/ZLRrUxl6G4AgMnWsattnhTdaoHGPwq9FwCKgB/s1600/Alaskan_Malamute_Lead_Shot.jpg',
    counts: [
      { location: 'USA', quantityAvailable: '32' },
      { location: 'Canada', quantityAvailable: '72' },
      { location: 'France', quantityAvailable: '23' },
      { location: 'United Kingdom', quantityAvailable: '45' },
      { location: 'Australia', quantityAvailable: '86' }
    ]
  },
  {
    name: 'American bully',
    ...
    counts: [
      { location: 'USA', quantityAvailable: '11' },
      { location: 'Canada', quantityAvailable: '0' },
      { location: 'France', quantityAvailable: '44' },
      { location: 'United Kingdom', quantityAvailable: '144' },
      { location: 'Australia', quantityAvailable: '10' }
    ]
  },
  {
    name: 'Basenji',
    ...
    picture: 'https://petsi.net/images/dogbreed/26.jpg',
    counts: [
      { location: 'USA', quantityAvailable: '22' },
      { location: 'Canada', quantityAvailable: '155' },
      { location: 'France', quantityAvailable: '3' },
      { location: 'United Kingdom', quantityAvailable: '88' },
      { location: 'Australia', quantityAvailable: '83' }
    ]
  },
  {
    name: 'Australian shepherd',
    ...
    picture: 'https://www.royal-canin.ru/upload/iblock/117/avstr.ovcharka2.jpg',
    counts: [
      { location: 'USA', quantityAvailable: '12' },
      { location: 'Canada', quantityAvailable: '24' },
      { location: 'France', quantityAvailable: '44' },
      { location: 'United Kingdom', quantityAvailable: '3' },
      { location: 'Australia', quantityAvailable: '32' }
    ]
  },
  {
    name: 'Australian cattle dog',
  ...
  },
  {
    ...
    counts: [
      { location: 'USA', quantityAvailable: '32' },
      { location: 'Canada', quantityAvailable: '34' },
      { location: 'France', quantityAvailable: '23' },
      { location: 'United Kingdom', quantityAvailable: '40' },
      { location: 'Australia', quantityAvailable: '93' }
    ]
  },
  {
    name: 'Alaskan Malamute',
    ...
    counts: [
      { location: 'USA', quantityAvailable: '11' },
      { location: 'Canada', quantityAvailable: '123' },
      { location: 'France', quantityAvailable: '12' },
      { location: 'United Kingdom', quantityAvailable: '23' },
      { location: 'Australia', quantityAvailable: '1' }
    ]
  },
  {
    name: 'American bully',
